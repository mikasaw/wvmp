...
> 更新时间：2026-09-02（MIT-451 X5b：**x86 保存区冲突修复**——entry guard 垫栈(N=128) + 翻译期栈深 walk gate + callgate 参数窗 4→8 + 跳表匹配器 S32 + REG-REG 位测试族；mul64hi 崩溃销账；wvmpTest x86 103 kernel 双跑 diff-0 达成；multiseed 305→**315**（池 11→13）；x64 dump `ffd47289…` 逐字节恒等）
