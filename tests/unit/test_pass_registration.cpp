// 跨模块验证：wvmp_passes_all 里的 11 个静态自注册 pass 全部能被 PassRegistry
...
TEST(PassRegistration, AllElevenPassesDiscoverable) {
    ...
    EXPECT_GE(names.size(), static_cast<size_t>(11));
