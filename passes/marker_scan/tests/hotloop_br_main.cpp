// wvmp_hotloop_br_sample: x64 branch/flags-dense microbenchmark main
// (MIT-494r / T41 word-mix matrix). Same QPC + checksum-anchor protocol as
...
extern "C" u32 hotloop_br64(u32 seed, u32 iters);
...
int main() {
    ...
    const u32 r = hotloop_br64(kSeed, kIters);
